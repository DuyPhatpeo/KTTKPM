...
public class MainBT4 {
    public static void main(String[] args) {
        ...
        qlcx.themChuyenXe(new ChuyenXeNgoaiThanh("005", "Phuc Ngu", "79A-111111", 100000,"Nha Trang",2));
        qlcx.themChuyenXe(new ChuyenXeNgoaiThanh("006", "Phuc Ngu", "79A-111111", 100000,"HCM",2));
        qlcx.themChuyenXe(new ChuyenXeNgoaiThanh("007", "Phuc Ngu", "79A-111111", 100000,"Ha Noi",2));
        qlcx.xuatDanhSach();
